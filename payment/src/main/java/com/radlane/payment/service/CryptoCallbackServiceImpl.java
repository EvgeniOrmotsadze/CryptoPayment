...
@Service
@Slf4j
public class CryptoCallbackServiceImpl implements CryptoCallbackService {

    private final CallbackVerifier callbackVerifier;
    private final ObjectMapper objectMapper;
    private final PaymentRepository paymentRepository;

    public CryptoCallbackServiceImpl(CallbackVerifier callbackVerifier, ObjectMapper objectMapper, PaymentRepository paymentRepository) {
